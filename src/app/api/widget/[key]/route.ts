...
function getWidgetCode(): string {
  ...
  function getSizeCSS() {
    ...
    if (s === "small") {
      return "#lsw-widget.lsw-size-small .lsw-container{padding:5px 10px 5px 8px;gap:4px}#lsw-widget.lsw-size-small .lsw-source-lang,#lsw-widget.lsw-size-small .lsw-target-lang{width:24px;height:24px}#lsw-widget.lsw-size-small .lsw-flag{font-size:14px}#lsw-widget.lsw-size-small .lsw-arrow{font-size:11px}#lsw-widget.lsw-size-small .lsw-dropdown{min-width:190px;max-height:300px}#lsw-widget.lsw-size-small .lsw-lang-option{padding:8px 10px}#lsw-widget.lsw-size-small .lsw-lang-option .lsw-flag{font-size:18px}#lsw-widget.lsw-size-small .lsw-lang-option .lsw-lang-name{font-size:13px}";
    }
    if (s === "large") {
      return "#lsw-widget.lsw-size-large .lsw-container{padding:10px 18px 10px 14px;gap:8px}#lsw-widget.lsw-size-large .lsw-source-lang,#lsw-widget.lsw-size-large .lsw-target-lang{width:36px;height:36px}#lsw-widget.lsw-size-large .lsw-flag{font-size:22px}#lsw-widget.lsw-size-large .lsw-arrow{font-size:17px}#lsw-widget.lsw-size-large .lsw-dropdown{min-width:260px;max-height:420px}#lsw-widget.lsw-size-large .lsw-lang-option{padding:12px 14px}#lsw-widget.lsw-size-large .lsw-lang-option .lsw-flag{font-size:26px}#lsw-widget.lsw-size-large .lsw-lang-option .lsw-lang-name{font-size:15px}";
    }
    return "";
  }
